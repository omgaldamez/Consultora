<script>
  ...
  onMount(() => {
    ...
    svg.append("g")
      ...
      .join("path")
      .attr("d", ribbon)
      .attr("fill", d => colors[d.source.index]) // Use source node color
      .attr("stroke", "white")
      .append("title")
...
<style>
  ...
  /* Your CSS styles for the chart */
</style>

<div id="chord-diagram">
  <!-- The container for your chart -->
  <svg bind:this={svgNode} style="width: 100vw; height: 100vh; font: 10px sans-serif;" />
</div>
